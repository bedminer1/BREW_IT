...
<div class="flex justify-center items-center min-h-screen w-full">
  <div class="border {$mode === "light" ? "border-zinc-300" : "border-zinc-900"} rounded-none p-10 w-full max-w-sm">
    ...
    <form method="POST" use:enhance class="flex flex-col gap-6">
      <div class="flex flex-col gap-2">
        ...
        <input
          ...
          class="p-3 border border-gray-300 rounded-none text-base focus:outline-none focus:border-black"
